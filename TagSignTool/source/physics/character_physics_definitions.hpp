...
struct s_character_physics_definition
{
	...
	c_typed_tag_block<struct s_physics_model_sphere> dead_sphere_shapes;

	// don't be a jerk, edit something else
	c_typed_tag_block<struct s_physics_model_pill> pill_shapes;

	// don't be a jerk, edit something else
	c_typed_tag_block<struct s_physics_model_sphere> sphere_shapes;
